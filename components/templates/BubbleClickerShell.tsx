...
export default function BubbleClickerShell({ title, subtitle, bullets, ctaText, icon, styleParams }: BaseProps) {
      ...
      <div className="relative z-10 container mx-auto px-6 pt-32 pb-20">
        ...
        <div className="text-center mb-20">
          <div className="inline-flex items-center space-x-3 mb-6 px-4 py-2 bg-white/10 backdrop-blur rounded-full border border-white/20">
            ...
            <span className="text-purple-400 text-sm font-medium">Bubble Clicker</span>
          </div>
